...
def run(i):
    ...
    """
    user_base_path = f'{ARGS.dataset_name}/processed'

    train_data_path = f'{user_base_path}/{i}/train/'
    val_data_path = f'{user_base_path}/{i}/val/'
    test_data_path = f'{user_base_path}/{i}/test/'

    # change ratio of data
    train_sample_infos, num_of_train_user = util.get_data_user_sep(train_data_path, 1)
    val_sample_infos, num_of_val_user = util.get_data_user_sep(val_data_path, 1)
    test_sample_infos, num_of_test_user = util.get_data_user_sep(test_data_path, 1)
