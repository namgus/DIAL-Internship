...
from colbert.modeling.tokenization import QueryTokenizer, DocTokenizer, tensorize_triples_lambda
...
class EagerBatcher():
    def __init__(self, args, rank=0, nranks=1):
        ...
        self.tensorize_triples = partial(tensorize_triples_lambda, self.query_tokenizer, self.doc_tokenizer)
