...
class Arguments():
    ...
    def add_model_training_parameters_termrecall(self):
        self.add_argument('--checkpoint', dest='checkpoint', default=None, required=False)
        ...
        self.add_argument('--amp', dest='amp', default=False, action='store_true')
        self.add_argument('--test_queries', dest='test_queries', default=None)

    def add_model_training_parameters_adaptation(self):
        self.add_argument('--checkpoint', dest='checkpoint', default=None, required=False)
